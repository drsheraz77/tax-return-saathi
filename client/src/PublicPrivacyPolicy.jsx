...
const policy = {
  ur: {
    ...
    updated: "آخری عملیاتی جائزہ: 30 اگست 2026",
    ...
    sections: [
      ...
      { h: "ہم کن معلومات کے ساتھ کام کرتے ہیں", b: "عوامی ٹولز میں براؤزر کے اندر عارضی تیاری انتخاب ہو سکتے ہیں۔ اختیاری سائن اِن صارف کے لیے محدود چیک لسٹ ڈرافٹ اور صرف پانچ مقررہ تیاری ترجیحات اکاؤنٹ سے منسلک ہو سکتی ہیں۔ واضح وزیٹر پیمائش اجازت کے بعد ایپ ہر UTC دن کے لیے صرف مجموعی سیشن سگنلز کی گنتی رکھ سکتی ہے؛ اس قطار میں IP، کوکی، اکاؤنٹ، صفحہ URL، ٹیکس/فارم، دستاویز یا فیڈبیک مواد نہیں ہوتا۔ فیڈبیک اکاؤنٹ یا رابطے سے منسلک نہیں کیا جاتا اور حساس شناختی یا مالی تفصیل شامل نہ کرنے کی ہدایت دی جاتی ہے۔" },
      ...
      { h: "کوکیز، مقامی انتخاب اور EU/EEA/UK", b: "ضروری سیشن اور سیکیورٹی ٹیکنالوجی سائن اِن خدمت کے لیے استعمال ہو سکتی ہے۔ اختیاری رازداری نوٹس تمام وزیٹرز کو دکھایا جاتا ہے، بشمول EU/EEA/UK، بغیر مقام معلوم کیے۔ واضح اجازت کے بعد ہی Google Analytics مجموعی وزٹ پیمائش کے لیے لوڈ ہو سکتی ہے اور analytics storage استعمال کر سکتی ہے، اور ایپ ایک براؤزر سیشن سے UTC دن کے لیے صرف مجموعی فرسٹ پارٹی سگنل گن سکتی ہے۔ انکار یا انتخاب ہٹانے پر ایپ مستقبل کی پیمائش روکنے اور دستیاب Google Analytics کوکیز صاف کرنے کی کوشش کرتی ہے؛ پہلے سے Google کے پاس موجود ڈیٹا کے لیے Google کے اپنے کنٹرول لاگو ہوتے ہیں۔" },
      { h: "تیسرے فریق اور اشتہارات", b: "انٹرفیس Urdu فونٹ کے لیے Google Fonts، style utility کے لیے Tailwind CDN resource، سائن اِن کے لیے ہوسٹنگ پلیٹ فارم کا OAuth، اور صرف اجازت کے بعد Google Analytics لوڈ کر سکتا ہے۔ ایپ Google Analytics کو ٹیکس یا فارم کا مواد، فیڈبیک متن، اکاؤنٹ شناخت، یا custom events نہیں بھیجتی اور Google signals اور ads personalization بند رکھتی ہے۔ Google Ads یا AdSense tag فعال نہیں۔ موجودہ نوٹس Google-certified CMP یا قانونی سرٹیفکیشن نہیں ہے۔" },
      { h: "رابطہ اور حق کی درخواست", b: "اس ایپ میں الگ عوامی data-protection contact یا DPO شائع نہیں کیا گیا۔ آزمائشی خدمت کے بارے میں اختیاری براہِ راست رائے driris@gmail.com پر بھیجی جا سکتی ہے، مگر ای میل گمنام نہیں اور اس فارم یا 30 دن والے گمنام فیڈبیک عمل سے الگ ہے۔ حساس تفصیل، شناخت یا ٹیکس معاملہ ای میل یا فیڈبیک فارم میں نہ بھیجیں۔ EU/EEA/UK سمیت کسی مقام کے حق، نمائندہ، قانونی بنیاد یا ریگولیٹری شکایت کے تقاضے کے لیے service owner کو مناسب قانونی مشورے کے ساتھ یہ تفصیل مکمل کرنی چاہیے۔" },
    ],
  },
  en: {
    label: "Public privacy policy · pilot release",
    title: "Privacy policy and pilot-service notice",
    updated: "Last operational review: 30 August 2026",
    ...
    sections: [
      ...
      { h: "Information we work with", b: "Public tools may hold temporary preparation choices in the browser. An optional signed-in user may have a limited checklist draft and only five controlled preparation preferences connected to an account. After clear visitor-measurement permission, the app may keep only an aggregate count of browser-session signals for each UTC day; that row contains no IP address, cookie, account, page URL, tax/form data, document, or feedback content. Feedback is not linked to an account or contact details, and people are told not to include sensitive identity or financial information." },
      ...
      { h: "Cookies, local choice, and EU/EEA/UK visitors", b: "Necessary session and security technology may be used for sign-in. An optional privacy notice is shown to every visitor, including people in the EU/EEA/UK, without determining location. Only after clear permission may Google Analytics load for aggregate visitor measurement and use analytics storage, and the app may record one first-party aggregate browser-session signal for the UTC day. If a person declines or resets the choice, the app stops future measurement and attempts to clear available Google Analytics cookies; data already held by Google remains subject to Google’s own controls." },
      { h: "Third parties and advertising", b: "The interface may load Google Fonts for Urdu typography, a Tailwind CDN resource for styling, the hosting platform’s OAuth for sign-in, and Google Analytics only after permission. The app does not send tax or form content, feedback text, account identifiers, or custom events to Google Analytics, and it disables Google signals and ads personalisation. Google Ads and AdSense tags are not enabled. The current notice is not a Google-certified CMP or legal certification." },
      { h: "Contact and rights requests", b: "A separate public data-protection contact or DPO is not currently published in this app. Optional direct pilot feedback may be emailed to driris@gmail.com, but email is not anonymous and is separate from the form and its 30-day anonymous-feedback process. Do not send sensitive details, identity information, or tax matters by email or through feedback. For EU/EEA/UK and other location-specific rights, representative, lawful-basis, or regulator-complaint requirements, the service owner must complete the necessary details with appropriate legal advice." },
    ],
  },
};
