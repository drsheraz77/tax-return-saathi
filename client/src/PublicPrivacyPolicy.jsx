...
const policy = {
  ur: {
    ...
    sections: [
      ...
      { h: "کوکیز، مقامی انتخاب اور EU/EEA/UK", b: "ضروری سیشن اور سیکیورٹی ٹیکنالوجی سائن اِن خدمت کے لیے استعمال ہو سکتی ہے۔ اختیاری رازداری نوٹس تمام وزیٹرز کو دکھایا جاتا ہے، بشمول EU/EEA/UK، بغیر مقام معلوم کیے۔ واضح اجازت کے بعد ہی Google Analytics مجموعی وزٹ پیمائش کے لیے لوڈ ہو سکتی ہے اور analytics storage استعمال کر سکتی ہے۔ انکار یا انتخاب ہٹانے پر ایپ مستقبل کی پیمائش روکنے اور دستیاب Google Analytics کوکیز صاف کرنے کی کوشش کرتی ہے؛ پہلے سے Google کے پاس موجود ڈیٹا کے لیے Google کے اپنے کنٹرول لاگو ہوتے ہیں۔" },
  ...
  en: {
    ...
    sections: [
      ...
      { h: "Cookies, local choice, and EU/EEA/UK visitors", b: "Necessary session and security technology may be used for sign-in. An optional privacy notice is shown to every visitor, including people in the EU/EEA/UK, without determining location. Only after clear permission may Google Analytics load for aggregate visitor measurement and use analytics storage. If a person declines or resets the choice, the app stops future measurement and attempts to clear available Google Analytics cookies; data already held by Google remains subject to Google’s own controls." },
