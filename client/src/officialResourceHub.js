export const OFFICIAL_RESOURCE_HUB = {
  ...
  sections: [
    ...
    {
      id: "large-business-industry",
      reviewedOn: "26 August 2026",
      title: "Large business & industry: tax-preparation starting points",
      titleUrdu: "بڑا کاروبار اور صنعت: ٹیکس تیاری کے ابتدائی ذرائع",
      introduction: "Use these current official FBR starting points to organise internal preparation questions for a company or industrial operation. They do not decide registration, tax treatment, sales-tax status, a return type, a deadline, or what FBR will accept.",
      introductionUrdu: "کمپنی یا صنعتی آپریشن کے لیے اندرونی تیاری کے سوالات ترتیب دینے کو یہ موجودہ سرکاری ایف بی آر ابتدائی ذرائع استعمال کریں۔ یہ رجسٹریشن، ٹیکس ٹریٹمنٹ، سیلز ٹیکس اسٹیٹس، ریٹرن کی قسم، ڈیڈ لائن یا ایف بی آر کی قبولیت طے نہیں کرتے۔",
      resources: [
        {
          id: "fbr-company-aop-enrolment",
          title: "Company & AOP income-tax registration orientation",
          titleUrdu: "کمپنی اور اے او پی انکم ٹیکس رجسٹریشن ابتدائی معلومات",
          description: "Review FBR’s official e-enrolment and registration starting point for company and AOP information before assigning any internal follow-up. Confirm the current official route directly with FBR.",
        ...
        },
        {
          ...
          title: "Income-tax return filing orientation",
          titleUrdu: "انکم ٹیکس ریٹرن فائلنگ ابتدائی معلومات",
          description: "Use FBR’s filing guidance to review the current official IRIS workflow topics before an authorised person uses the official portal. This link does not identify the right return or confirm a filing obligation.",
        ...
        },
        {
          ...
          title: "Income-tax record-keeping orientation",
          titleUrdu: "انکم ٹیکس ریکارڈ رکھنے کی ابتدائی معلومات",
          description: "Review FBR’s record-keeping destination to frame private internal record-readiness questions. Keep records outside this site and seek qualified clarification where the official material needs interpretation.",
        ...
        },
        {
          ...
          title: "Sales-tax registration starting point",
          titleUrdu: "سیلز ٹیکس رجسٹریشن کا ابتدائی ذریعہ",
          description: "Review FBR’s official sales-tax registration starting point before relying on any non-official checklist. This does not decide whether a business must register.",
        ...
        },
        {
          ...
          title: "Sales-tax return filing starting point",
          titleUrdu: "سیلز ٹیکس ریٹرن فائلنگ کا ابتدائی ذریعہ",
          description: "Use FBR’s official sales-tax filing destination to review the current portal route for registered-person workflows. It does not identify a taxpayer’s status, calculation, return, or filing timing.",
...
export const COMPLEX_SITUATION_PREPARATION_PATHS = [
  ...
  {
    id: "freelancer-individual-work",
    label: "Individual freelancer, remote work, or changing self-employment pattern",
    labelUrdu: "انفرادی فری لانسر، ریموٹ کام یا بدلتی ہوئی خود روزگاری کی صورت",
    boundary: "Use current official guidance and qualified help where your facts need interpretation; this navigator does not classify your work or decide an obligation, exemption, or tax treatment.",
    boundaryUrdu: "جہاں حقائق کی تشریح درکار ہو موجودہ سرکاری رہنمائی اور اہل مدد استعمال کریں؛ یہ رہنما آپ کے کام کی درجہ بندی، ذمہ داری، استثنا یا ٹیکس ٹریٹمنٹ طے نہیں کرتا۔",
    url: "https://www.fbr.gov.pk/categ/file-income-tax-return/51147/80860/71159",
    sourceLabel: "Review FBR filing help",
  },
  {
    id: "company-industry-operation",
    label: "Company, industrial operation, partnership, or changing business model",
    labelUrdu: "کمپنی، صنعتی آپریشن، شراکت داری یا بدلتا ہوا کاروباری ماڈل",
    boundary: "Use the separate Large Business & Industry official-source section and qualified help where facts need interpretation; this navigator does not classify an entity or decide registration, sales-tax status, a return, or an obligation.",
    boundaryUrdu: "جہاں حقائق کی تشریح درکار ہو الگ بڑے کاروبار اور صنعت کے سرکاری ذرائع والا حصہ اور اہل مدد استعمال کریں؛ یہ رہنما ادارے کی درجہ بندی، رجسٹریشن، سیلز ٹیکس اسٹیٹس، ریٹرن یا ذمہ داری طے نہیں کرتا۔",
    url: "https://www.fbr.gov.pk/categ/register-income-tax/51147/30846/71148",
    sourceLabel: "Review FBR income-tax registration guidance",
  },
  {
...
export function getOfficialResourceCategoryReview(section) {
  return {
    reviewedOn: section.reviewedOn || OFFICIAL_RESOURCE_HUB.reviewedOn,
