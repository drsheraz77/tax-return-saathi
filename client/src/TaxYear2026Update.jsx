  ...
  return (
    <aside className="tax-year-update" aria-label="Verified Tax Year 2026 filing updates">
      <style>{`
        ...
        .tax-year-update__panel { width: min(390px, calc(100vw - 32px)); margin-bottom: 10px; overflow: hidden; border: 1px solid #d6bd67; border-radius: 14px; background: #fffdf5; color: #173b31; box-shadow: 0 16px 40px rgba(10, 43, 33, .24); }
      ...
      <button className="tax-year-update__toggle" type="button" onClick={() => setIsOpen((open) => !open)} aria-expanded={isOpen} aria-controls="tax-year-update-panel">
