...
const T = {
  en: {
    ...
    privacySections: [
      ...
      { h: "What happens to documents and notices you upload", b: "When you use the notice-explainer or document gap-check, the file or text you provide is sent securely to an AI service (Anthropic's Claude) to generate the explanation, and the response is shown back to you. Your uploads are used only to answer your request in that moment. This app does not build a profile of you, does not sell your data, and does not store your documents on our own server after your request is answered." },
    ...
    checkPrivacy: "Your document is sent to the AI only for this analysis and is not stored by this app. You may mask your CNIC number before uploading if you prefer.",
  ...
  ur: {
    ...
    privacySections: [
      ...
      { h: "آپ کے اپ لوڈ کردہ دستاویزات اور نوٹسز کا کیا ہوتا ہے", b: "جب آپ نوٹس ایکسپلینر یا دستاویزات کی جانچ استعمال کرتے ہیں، تو آپ کی فراہم کردہ فائل یا متن وضاحت بنانے کے لیے محفوظ طریقے سے ایک اے آئی سروس (Anthropic کے Claude) کو بھیجا جاتا ہے، اور جواب آپ کو دکھایا جاتا ہے۔ آپ کے اپ لوڈ صرف اسی وقت آپ کی درخواست کا جواب دینے کے لیے استعمال ہوتے ہیں۔ یہ ایپ آپ کی پروفائل نہیں بناتی، آپ کا ڈیٹا فروخت نہیں کرتی، اور جواب کے بعد آپ کی دستاویزات اپنے سرور پر محفوظ نہیں رکھتی۔" },
    ...
    checkPrivacy: "آپ کی دستاویز صرف اسی تجزیے کے لیے اے آئی کو بھیجی جاتی ہے اور یہ ایپ اسے محفوظ نہیں کرتی۔ چاہیں تو اپ لوڈ سے پہلے شناختی کارڈ نمبر چھپا سکتے ہیں۔",
