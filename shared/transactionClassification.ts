...
const patterns: Array<{ category: TransactionCategory; pattern: RegExp; confidence: "high" | "medium"; reason: string }> = [
  ...
  { category: "property_sale", pattern: /property|plot|land|house|flat|apartment|sale proceeds|بيع|پلاٹ|مکان|فروخت/i, confidence: "medium", reason: "Description contains property/real-estate terminology; supporting sale documents should confirm the classification." },
  { category: "property_purchase", pattern: /property|plot|land|house|flat|apartment|purchase|booking|allotment|registry|transfer fee|پلاٹ|خرید/i, confidence: "medium", reason: "Description contains property acquisition terminology; supporting purchase documents should confirm the classification." },
